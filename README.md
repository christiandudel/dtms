...
dtms_expectancy(dtms=simple,
                ...
                matrix=Tp)
#>                  0        1        2        3        4        5        6
#> start:A_0 5.006818 4.694051 4.387121 4.086756 3.793721 3.508792 3.232746
#> start:B_0 4.774829 4.460056 4.150827 3.847848 3.551860 3.263624 2.983902
#>                  7        8        9       10       11       12       13
#> start:A_0 2.966329 2.710219 2.464994 2.231025 2.008520 1.797071 1.596393
#> start:B_0 2.713433 2.452900 2.202883 1.963824 1.735883 1.519020 1.312339
#>                 14       15        16        17        18  19
#> start:A_0 1.403558 1.219479 1.0284166 0.8538373 0.5827048 0.5
#> start:B_0 1.115226 0.923136 0.7377421 0.5341427 0.3529947 0.0
```
...
dtms_visits(dtms=simple,
            ...
            start_distr=S)
#>                         0           0.5             1        1.5             2
#> start:A_0      0.00000000  3.344800e-02 -6.938894e-18 0.05798264 -1.387779e-17
#> start:B_0      0.02527496 -3.469447e-18  5.016242e-02 0.00000000  8.200508e-02
#> AVERAGE        0.01253069  1.686533e-02  2.486925e-02 0.02923632  4.065604e-02
#> AVERAGE(COND.) 0.02527496 -3.469447e-18  5.016242e-02 0.00000000  8.200508e-02
#>                       2.5          3           3.5             4        4.5
#> start:A_0      0.09272739 0.00000000  1.327856e-01 -5.551115e-17 0.16612892
#> start:B_0      0.00000000 0.12104579 -5.551115e-17  1.572430e-01 0.00000000
#> AVERAGE        0.04675550 0.06001144  6.695389e-02  7.795712e-02 0.08376641
#> AVERAGE(COND.) 0.00000000 0.12104579 -5.551115e-17  1.572430e-01 0.00000000
#>                         5        5.5          6        6.5          7
...
#> start:B_0      7.612808e-10 1.110223e-16 7.491230e-12 0.000000e+00 4.451994e-14
#> AVERAGE        3.774237e-10 1.020375e-10 3.713962e-12 9.236743e-13 2.207186e-14
#> AVERAGE(COND.) 7.612808e-10 1.110223e-16 7.491230e-12 0.000000e+00 4.451994e-14
#>                        17.5           18         18.5 19          19.5
#> start:A_0      1.021405e-14 2.220446e-16 0.000000e+00  0  0.000000e+00
#> start:B_0      1.110223e-16 0.000000e+00 2.220446e-16  0 -2.220446e-16
#> AVERAGE        5.205226e-15 1.119605e-16 1.100841e-16  0 -1.100841e-16
#> AVERAGE(COND.) 1.110223e-16 0.000000e+00 2.220446e-16  0 -2.220446e-16
#>                           20         20.5
#> start:A_0      -2.220446e-16 4.440892e-16
#> start:B_0       2.220446e-16 0.000000e+00
#> AVERAGE        -1.876433e-18 2.239210e-16
#> AVERAGE(COND.)  2.220446e-16 0.000000e+00
#> attr(,"class")
#> [1] "dtms_distr" "matrix"
...
#> $`2.5%`
#>                        Working Non-working  Retired    TOTAL
#> start:Working_50     13.098659    2.937170 13.17015 29.49845
#> start:Non-working_50  8.496322    6.229323 13.34982 28.47697
#> start:Retired_50      8.598403    3.669029 14.68985 27.31119
#> AVERAGE              12.156152    3.449322 13.27326 29.25158
#> start:Working_50     11.769945    4.235533 16.12174 32.68755
#> start:Non-working_50  7.164567    8.002026 16.34999 32.08289
#> start:Retired_50      7.558472    5.272417 17.73994 31.11063
#> AVERAGE              10.123005    5.419983 16.26947 32.44921
#> 
#> $`97.5%`
#>                        Working Non-working  Retired    TOTAL
#> start:Working_50     13.639759    3.187505 13.81703 30.38998
#> start:Non-working_50  9.161724    6.705641 14.09615 29.56186
#> start:Retired_50      9.267329    4.091790 15.60496 28.58963
#> AVERAGE              12.782517    3.732651 13.94862 30.18124
#> start:Working_50     12.392232    4.560908 16.93943 33.46610
#> start:Non-working_50  7.736188    8.447436 17.24471 32.96200
#> start:Retired_50      8.190454    5.739666 18.89283 32.28779
#> AVERAGE              10.769256    5.842989 17.12334 33.23954
```
