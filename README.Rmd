...
- Data handling: functions for reshaping data, cleaning data, editing states, 
generating indicators of duration and number of occurrences of a state, 
indicators of censoring, descriptive information on different types of 
censoring, and other general descriptive statistics. 
- Estimation of transition probabilities: semiparametric estimation ([VGAM](https://cran.r-project.org/web/packages/VGAM)), random effects and 
random intercepts ([mclogit](https://cran.r-project.org/web/packages/mclogit)), 
...
Neglect Volume 169(1): 107626. https://doi.org/10.1016/j.chiabu.2025.107626
