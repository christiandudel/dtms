...
Before we generate several results, we calculate the starting distribution of
...
Retirement Study (HRS). The simulations are based on transition probabilities
estimated from the HRS as part of Dudel & Myrskylä (2017) who studied working
trajectories in late working life and old age. There are three transient states 
...
individuals. The data set also contains each individual's gender, and the 
transition probabilities underlying the simulated trajectories differ between
men and women. 
