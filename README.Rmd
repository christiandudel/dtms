...
be used. The file `all.R` is all code from `dtms`. Sourcing it should provide 
a lot of the functionality of the package; dependencies are still required, 
though. The file `selected.R` only includes a subset of the functions and 
removes most of the documentation, but is much smaller than `all.R`. 
