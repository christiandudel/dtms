...
We thank Alessandro Feraldi, Aapo Hiilamo, Daniel Schneider, Donata Stonkute, 
and Angelo Lorenti for helpful comments and suggestions. All errors remain 
our own.
...
indicators of censoring, general descriptive statistics, and descriptive 
information on different types of censoring. 
...
(partial) distribution of waiting time to absorption, based on (partial) 
distributions variance/standard deviation and median of occupancy 
time/first visit/last exit/time to absorption, survivorship function, 
...
bootstrap for other quantities, supports parallel computing.
- Other features: simulation of Markov chains using the package
[markovchain](https://cran.r-project.org/web/packages/markovchain); limited 
support of survey weights; limited support of irregular time intervals.
